...
public class realTimeImp implements realTimeInter {
	...
	public List<Object> getRealTimePhoto(int cityId) {
		String findUserImgId = "select img_url from upload join img on upload.upload_img_id=img.id where upload.upload_city_id=? ORDER BY upload.upload_time DESC;";
